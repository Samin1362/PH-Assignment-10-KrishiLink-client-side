          ...
          <div className="relative z-10 max-w-lg text-white">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-semibold mb-1">Direct Connections</h4>
                  <p className="text-sm text-[#E8F5E9]">
                    Connect directly with buyers and farmers
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-semibold mb-1">Fast & Secure</h4>
                  <p className="text-sm text-[#E8F5E9]">
                    Quick transactions with trusted partners
                  </p>
                </div>
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="text-right">
                  <button
                    ...
                    className="text-sm text-[#4CAF50] hover:text-[#2E7D32] font-semibold transition-colors hover:underline"
                  >
                    Forgot Password?
                  </button>
                </div>
              ...
              <form onSubmit={handleForgotPassword} className="space-y-5">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    type="submit"
                    disabled={isResetting}
                    className="flex-1 btn-primary py-3 disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center justify-center gap-2"
                  >
                    {isResetting ? (
                      <>
                        <svg
